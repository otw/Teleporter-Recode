...
public class Place {
	...
	public final PlaceType mPlaceType;
	...
	public Place(final int pLatitudeE6, final int pLongitudeE6, final PlaceType pPlaceType, final String pName, final String pAddress) {
		this.mLatitudeE6 = pLatitudeE6;
		this.mLongitudeE6 = pLongitudeE6;
		this.mPlaceType = pPlaceType;
		this.mName = pName;
	...
	public int hashCode() {
		...
		result = prime * result + ((this.mPlaceType == null) ? 0 : this.mPlaceType.hashCode());
		return result;
	}
	...
	public boolean equals(final Object obj) {
		...
		if(this.mPlaceType == null) {
			if(other.mPlaceType != null) {
				return false;
			}
		} else if(!this.mPlaceType.equals(other.mPlaceType)) {
			return false;
		}
		return true;
	}
